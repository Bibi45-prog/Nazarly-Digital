...
export default function Home() {
  ...
  return (
    <div className="relative items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-[#0D0D0D] text-white ">
      ...
      <div
        className="relative flex flex-col justify-center items-center h-[80vh] sm:h-[60vh] md:h-[50vh] bg-contain bg-center bg-no-repeat my-20"
      ...
      >
        ...
        <div className="relative z-10 text-white text-center">
          <h1 className="text-5xl sm:text-md">
